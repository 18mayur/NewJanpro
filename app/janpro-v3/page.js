...
export default function Page() {
  ...
  useEffect(() => {
    ...
    // second video gsap handshake video
  ...
  return (
    <>
      ...
      <div className="main-div">
        ...
        {/*1st  Video section + Content section */}
        <section
          ref={section4Ref}
          className="h-screen flex relative overflow-hidden"
        >
          {/* Left Texts (only 2) */}
          <div className="w-1/2 flex items-center justify-start ml-[6rem] relative">
            <div className="absolute text-6xl font-bold">
              <div ref={(el) => (textsRef4.current[0] = el)}>
                <di v className="flex flex-col justify-center text-[#003da6]">
                  <h4 className="text-[#78bf21] text-[1rem] font-bold mb-3">
                    GLOBAL STORY
                  </h4>
              ...
              >
                <div className="flex flex-col justify-center text-[#003da6]">
                  <h4 className="text-[#78bf21] text-[1rem] font-bold mb-3">
                    GLOBAL STORY
                  </h4>
                  <h2 className="text-[1.75rem] font-bold leading-[2.25rem] mb-[1rem]">
          ...
          >
            <div
              className="video-inner w-full relative flex justify-end"
